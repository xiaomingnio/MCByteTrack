...
public:
    ...
    std::map<int, vector<STrack>> update(std::map<int, vector<Object>>& objects);
...
private:
    ...
    std::map<int, vector<STrack>> tracked_stracks_;
    std::map<int, vector<STrack>> lost_stracks_;
    std::map<int, vector<STrack>> removed_stracks_;
